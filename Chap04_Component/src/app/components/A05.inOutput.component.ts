...
@Component({
    ...
    template: `
        <div class="panel-body">
            ...
            Data obj: {{data?.obj.tel}}<br>
            Data obj.static: {{data?.static}}
            <br>
        </div>
    `
})
...
@Component({
    ...
    template: `
        <div class="panel-body">
            ...
            -->
            <a05One (sendnameEvent)="getNameEvent($event)"
            (sendObjectEvent)="getObjectEvent($event)"></a05One>
